  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      <View className="px-6 pt-4 pb-2">
        <Text className="text-3xl font-bold text-gray-900">Your Favorites</Text>
        ...
        {favoriteMeals.map((meal) => (
          <TouchableOpacity
            ...
            <View className="flex-row">
              <Image source={{ uri: meal.image }} className="w-24 h-24" />
              <View className="flex-1 p-4">
                <Text className="text-lg font-bold text-gray-900 mb-1">{meal.name}</Text>
                ...
                <View className="flex-row items-center space-x-4">
                  <View className="flex-row items-center">
                    ...
                    <Text className="text-gray-500 ml-1 text-xs">{meal.cookingTime}min</Text>
                  </View>

                  <View className="flex-row items-center">
                    <Users size={14} color="#6b7280" />
                    <Text className="text-gray-500 ml-1 text-xs">{meal.servings}</Text>
                  </View>

                  <View className="flex-row items-center">
                    <Flame size={14} color="#6b7280" />
                    <Text className="text-gray-500 ml-1 text-xs">{meal.calories}cal</Text>
                  </View>
                </View>
              </View>
            </View>
